...
**makeId** | **number** |  | [optional] [default to undefined]
**modelId** | **number** |  | [optional] [default to undefined]
**bikeVariantId** | **number** |  | [optional] [default to undefined]

## Example

```typescript
import { SavePartsBikeDto } from './api';

const instance: SavePartsBikeDto = {
    id,
    vin,
    notes,
    partsCatalogUrl,
